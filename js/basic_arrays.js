...
let languages = ['Javascript', 'PHP', 'CSS', 'Python', 'HTML', 'ASP', 'Go'];
...
console.log(languages.unshift = 'VB');
//console.log(languages);
...
console.log(languages.pop() + " Removed");
console.log(languages);
// 9. Use an array method to REMOVE the first element from the array.
console.log(languages.shift() + " has been removed");
console.log(languages);
