/* ----------------------------------------------------------
        ...
        TEAM TREE HOUSE FUNCTIONS PRACTICE
        
        come back to this for pratice.

        https://teamtreehouse.com/library/-javascript-quickstart/objects-and-conditionals/before-you-start
-------------------------------------------------------------*/

// 1. Attach this file geometry.js to the index.html file

// 2. Create a function that calculates the area of a rectangle.
//    The function should accept the width and height as arguments (Parameters)
...
function calcRectPrism(width, height, length){
...
//Area Rectangle
console.log(calcAreaRect(5, 22));

//Volume of Rectangle
console.log(calcRectPrism(4.5, 12.5, 17.4));

//Area of Circle
console.log(calcAreaCircle(7.2));

//Volume of Sphere
console.log(calcSphere(7.2));
